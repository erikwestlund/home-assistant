...
def insert_to_db(data):
    ...
    INSERT INTO heat_data (
        timestamp, room, temp, temp_change_5m, temp_change_15m, temp_change_60m,
        outdoor_temp_current, outdoor_temp_5m_ago, outdoor_temp_15m_ago, outdoor_temp_60m_ago,
        temp_5m_window, office_average_temp, family_room_average_temp, living_room_average_temp,
        dining_room_temp, erik_office_temp, master_bedroom_average_temp, kids_bedrooms_average_temp,
        hank_bedroom_temp, tilly_bedroom_temp, office_average_temperature_5m_ago, 
        family_room_average_temperature_5m_ago, living_room_average_temperature_5m_ago, 
        dining_room_temperature_5m_ago, erik_office_temperature_5m_ago, 
        master_bedroom_average_temperature_5m_ago, kids_rooms_average_temperature_5m_ago,
        hank_room_temperature_5m_ago, tilly_room_temperature_5m_ago, office_radiator_power_status,
        ...
        master_bedroom_mini_split_setpoint, ducted_setpoint, office_radiator_setpoint_5m_ago,
        family_room_radiator_setpoint_5m_ago, main_zone_radiator_setpoint_5m_ago, office_mini_split_setpoint_5m_ago,
        family_room_mini_split_setpoint_5m_ago, living_room_mini_split_setpoint_5m_ago,
        dining_room_mini_split_setpoint_5m_ago, erik_office_mini_split_setpoint_5m_ago,
        master_bedroom_mini_split_setpoint_5m_ago, ducted_setpoint_5m_ago)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);
    """
    ...
    cursor.execute(query, (
        ...
        data['office_average_temperature_5m_ago'],
        data['family_room_average_temperature_5m_ago'],
        data['living_room_average_temperature_5m_ago'],
        data['dining_room_temperature_5m_ago'],
        data['erik_office_temperature_5m_ago'],
        data['master_bedroom_average_temperature_5m_ago'],
        data['kids_rooms_average_temperature_5m_ago'],
        data['hank_room_temperature_5m_ago'],
        data['tilly_room_temperature_5m_ago'],
        ...
        data['office_radiator_setpoint_5m_ago'],
        data['family_room_radiator_setpoint_5m_ago'],
        data['main_zone_radiator_setpoint_5m_ago'],
        data['office_mini_split_setpoint_5m_ago'],
        data['family_room_mini_split_setpoint_5m_ago'],
        data['living_room_mini_split_setpoint_5m_ago'],
        data['dining_room_mini_split_setpoint_5m_ago'],
        data['erik_office_mini_split_setpoint_5m_ago'],
        data['master_bedroom_mini_split_setpoint_5m_ago'],
        data['ducted_setpoint_5m_ago']
    ))
