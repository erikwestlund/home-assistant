...
def insert_to_db(data):
    ...
    INSERT INTO heat_data (
        timestamp, room, temp, temp_change_60m, temp_change_160m, temp_change_60m,
        outdoor_temp_current, outdoor_temp_60m_ago, outdoor_temp_160m_ago, outdoor_temp_60m_ago,
        temp_60m_window, office_average_temp, family_room_average_temp, living_room_average_temp,
        dining_room_temp, erik_office_temp, master_bedroom_average_temp, kids_bedrooms_average_temp,
        hank_bedroom_temp, tilly_bedroom_temp, office_average_temperature_60m_ago, 
        family_room_average_temperature_60m_ago, living_room_average_temperature_60m_ago, 
        dining_room_temperature_60m_ago, erik_office_temperature_60m_ago, 
        master_bedroom_average_temperature_60m_ago, kids_rooms_average_temperature_60m_ago,
        hank_room_temperature_60m_ago, tilly_room_temperature_60m_ago, office_radiator_power_status,
        ...
        master_bedroom_mini_split_setpoint, ducted_setpoint, office_radiator_setpoint_60m_ago,
        family_room_radiator_setpoint_60m_ago, main_zone_radiator_setpoint_60m_ago, office_mini_split_setpoint_60m_ago,
        family_room_mini_split_setpoint_60m_ago, living_room_mini_split_setpoint_60m_ago,
        dining_room_mini_split_setpoint_60m_ago, erik_office_mini_split_setpoint_60m_ago,
        master_bedroom_mini_split_setpoint_60m_ago, ducted_setpoint_60m_ago)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);
    """
    ...
    cursor.execute(query, (
        ...
        data['temp_change_160m'],
        data['temp_change_60m'],
        data['outdoor_temp_current'],
        data['outdoor_temp_60m_ago'],
        data['outdoor_temp_160m_ago'],
        data['outdoor_temp_60m_ago'],
        data['temp_60m_window'],
        ...
        data['office_average_temperature_60m_ago'],
        data['family_room_average_temperature_60m_ago'],
        data['living_room_average_temperature_60m_ago'],
        data['dining_room_temperature_60m_ago'],
        data['erik_office_temperature_60m_ago'],
        data['master_bedroom_average_temperature_60m_ago'],
        data['kids_rooms_average_temperature_60m_ago'],
        data['hank_room_temperature_60m_ago'],
        data['tilly_room_temperature_60m_ago'],
        ...
        data['office_radiator_setpoint_60m_ago'],
        data['family_room_radiator_setpoint_60m_ago'],
        data['main_zone_radiator_setpoint_60m_ago'],
        data['office_mini_split_setpoint_60m_ago'],
        data['family_room_mini_split_setpoint_60m_ago'],
        data['living_room_mini_split_setpoint_60m_ago'],
        data['dining_room_mini_split_setpoint_60m_ago'],
        data['erik_office_mini_split_setpoint_60m_ago'],
        data['master_bedroom_mini_split_setpoint_60m_ago'],
        data['ducted_setpoint_60m_ago']
    ))
